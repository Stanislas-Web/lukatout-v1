...
class _VersionScreenState extends State<VersionScreen> {
  ...
  // final Uri _url = Uri.parse('https://play.google.com/store/apps/details?id=com.app.lukatout');
  final Uri _url = Uri.parse('market://details?id=com.app.lukatout');

  // final Uri _urlIOS = Uri.parse('itms-apps://itunes.apple.com/cd/app/id1548263651?mt=8');
  final Uri _urlIOS =
      Uri.parse('https://itunes.apple.com/cd/app/id6472609211?mt=8');
