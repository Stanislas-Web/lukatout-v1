...
import 'package:lukatout/utils/color.util.dart';
  ...
  Widget build(BuildContext context) {
    return CachedNetworkImage(
      ...
      imageBuilder: (context, imageProvider) => Container(
        ...
        margin: EdgeInsets.only(right:this.widget.marginLeft??0),
        decoration: BoxDecoration(
          borderRadius: this.widget.borderRadius, //  BorderRadius.circular(40),
          border: this.widget.border ?? Border.all(color: Colors.transparent, width: 1),
