...
class TransAcademiaBiographieInput extends StatefulWidget {
  const TransAcademiaBiographieInput(
      {super.key,
      this.field,
      this.fieldValue,
      this.controller,
  ...
  _TransAcademiaBiographieInputState createState() =>
      _TransAcademiaBiographieInputState();
}

class _TransAcademiaBiographieInputState extends State<TransAcademiaBiographieInput> {
