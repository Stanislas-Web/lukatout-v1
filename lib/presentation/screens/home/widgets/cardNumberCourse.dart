    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.only(
          bottomLeft:
              Radius.circular(30.0), // Ajustez le rayon comme vous le souhaitez
          bottomRight:
              Radius.circular(30.0), // Ajustez le rayon comme vous le souhaitez
        ),
                      ...
                      builder: (context) => Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            SizedBox(
                                height: 300,
                                child: GoodGamer(gamers: dataGamer ?? [])),
                            Divider(),
                          ],
                        ),
                      ),
                ...
                InkWell(
                  onTap: () async {
                    SharedPreferences prefs =
                        await SharedPreferences.getInstance();
                    BlocProvider.of<SignupCubit>(context).updateField(context,
                        field: "phone", data: prefs.getString("phone"));
                    BlocProvider.of<SignupCubit>(context).updateField(context,
                        field: "phonePayment", data: prefs.getString("phone"));

                    BlocProvider.of<SignupCubit>(context).updateField(context,
                        field: "nombreCarte", data: "100");
